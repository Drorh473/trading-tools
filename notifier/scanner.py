...
# RUNNER_LEVEL_ATR_PERIOD lives in notifier.trailing_stops (imported above) -
# both this module's runner_target() and TrailingStopManager's trailing_stop()
# read structure off the same ATR period, so there is one definition.
...
class Scanner:
    def __init__(
        ...
        self._trailing = TrailingStopManager(bitget, storage, bot, self._bar_cache, self.manages_exits)
